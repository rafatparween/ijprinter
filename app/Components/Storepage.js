            ...
            <div className="mt-8 border-t pt-4">
                <a href="/support" className="text-blue-600 flex items-center space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="48" viewBox="0 0 45 48" fill="none">
                        <g clipPath="url(#clip0_8090_2190)">
                            <path d="M41.5701 46.23C39.2781 43.2712 36.3453 40.8702 32.9922 39.2075C29.6391 37.5448 25.9527 36.6635 22.2101 36.63C18.4724 36.6635 14.7908 37.5427 11.4414 39.2018C8.09192 40.861 5.16159 43.2569 2.87012 46.21" stroke="#027AAE" strokeWidth="2.29" strokeLinecap="round" strokeLinejoin="round" />
                            ...
                            <path d="M21.88 32.21C19.074 32.2076 16.3459 31.2868 14.1124 29.5882C11.8789 27.8896 10.2628 25.5066 9.5109 22.8032C8.75903 20.0997 8.91273 17.2245 9.94852 14.6167C10.9843 12.0088 12.8453 9.81168 15.2471 8.36086C17.649 6.91005 20.4597 6.28531 23.25 6.58206C26.0403 6.87882 28.6567 8.08076 30.6997 10.0043C32.7427 11.9278 34.0999 14.4672 34.564 17.2346C35.0281 20.002 34.5737 22.8452 33.27 25.33" stroke="#027AAE" strokeWidth="2.29" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M3.75 19.24C3.76774 14.7591 5.44423 10.4436 8.45606 7.1258C11.4679 3.80805 15.6016 1.72318 20.0599 1.27337C24.5182 0.823567 28.9851 2.0407 32.599 4.68998C36.2128 7.33926 38.7176 11.233 39.63 15.62C39.63 16.79 39.63 23.91 39.63 25.3C38.63 29.91 35.07 30.1 27.63 30.1" stroke="#027AAE" strokeWidth="2.29" strokeMiterlimit="10" strokeLinecap="round" />
                        </g>
                        <defs>
