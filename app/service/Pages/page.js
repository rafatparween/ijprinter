  ...
  return (
    <>
     <NavbarSection/>
      ...
      <section
  className="relative flex flex-col justify-center items-center text-center py-12 h-[380px] bg-cover bg-center"
  style={{
    backgroundImage: "url('/topback.png')"
  }}
>
  ...
  <div className="relative z-10">
    {/* <h1 className="text-white">Your Content Here</h1> */}
          ...
          <div className=" inset-0 opacity-80"></div>
          <div className="relative z-10 text-white 2xl:mt-[17px] xl:mt-[-29px] 2xl:ml-[-825px] xl:ml-[-567px]  ">
            <h1 className="text-4xl font-hp-simplified text-[44px] 2xl:ml-[12px] xl:ml-[-11px]">Get started with your HP printer</h1>
            <p className="mt-[35px] text-[24px] xl:ml-[238px] 2xl:ml-[270px]">Enter your printer name and model number to get the right HP software and drivers.</p>
            ...
            {/* Dropdown for filtered models */}
            {filteredModels.length > 0 && (
              <ul className="absolute left-0 mt-1 w-full max-w-lg bg-white border border-gray-300 rounded-lg shadow-lg z-10 2xl:ml-[265px] xl:ml-[228px] text-black">
                {filteredModels.map((model) => (
                  <li
                    key={model}
                    onClick={() => handleModelClick(model)} // Set model on click
